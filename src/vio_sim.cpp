...
//  ROS_INFO("=======================================");
  ...
  std::string path_traj = "/home/niko/programming/libs/open_vins/ov_data/sim/udel_gore.txt";
...
std::vector<std::pair<size_t, Eigen::VectorXf>> Simulator::project_pointcloud(const Eigen::Matrix3d &R_GtoI,
                                                                              ...
                                                                              int camid,
                                                                              const msckf::AlignedUnorderedMap<size_t,Vec3d>::type &feats) {
...
void Simulator::generate_points(const Eigen::Matrix3d &R_GtoI, const Eigen::Vector3d &p_IinG,
                                int camid, msckf::AlignedUnorderedMap<size_t,Vec3d>::type &feats, int numpts) {
