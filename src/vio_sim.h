...
public:
  ...
  msckf::AlignedUnorderedMap<size_t,Vec3d>::type get_map() {
    return featmap;
  }
...
protected:
   ...
   */
  std::vector<std::pair<size_t,Eigen::VectorXf>> project_pointcloud(const Eigen::Matrix3d &R_GtoI, const Eigen::Vector3d &p_IinG, int camid, const msckf::AlignedUnorderedMap<size_t,Vec3d>::type &feats);
   ...
   */
  void generate_points(const Eigen::Matrix3d &R_GtoI, const Eigen::Vector3d &p_IinG, int camid, msckf::AlignedUnorderedMap<size_t,Vec3d>::type &feats, int numpts);
  ...
  size_t id_map = 0;
  msckf::AlignedUnorderedMap<size_t,Vec3d>::type featmap;
